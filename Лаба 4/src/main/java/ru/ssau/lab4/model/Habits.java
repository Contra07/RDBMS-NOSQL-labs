...
@Primary
@Component
public class Habits implements Entitiable<Habits>
{
    @IgnoreEdit
    ...
    public Habits clone() 
    {
        var h = new Habits(id, userId, sleepHours, physicalActivityDays, socialInteractionFreq, year);
        return h;
    }
